...
@CoolRestController(api = {"add", "delete", "update", "page", "list", "info"}, cname = "searchKeyword")
public class AdminGoodsSearchKeywordController extends BaseController<GoodsSearchKeywordService, GoodsSearchKeywordEntity> {
    @Override
